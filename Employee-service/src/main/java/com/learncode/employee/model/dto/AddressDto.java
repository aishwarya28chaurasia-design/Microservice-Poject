...
import com.learncode.employee.enums.AddressType;
...
public class AddressDto {
    ...
    private com.learncode.employee.enums.AddressType addressType;
    ...
    public String toString() {
        return "AddressDto [id=" + id + ", empId=" + empId + ", street=" + street + ", pinCode=" + pinCode + ", city=" + city
